// export type KPopAlbum = {
//   id: string;
//   title: string;
//   type: 'single' | 'mini' | 'full' | 'ost'; // Kislemez, Minialbum (EP), Stúdióalbum vagy OST
//   releaseDate: string; // Megjelenés dátuma, pl. "2024.08.30"
//   coverImage: string;  // Az album borítójának útvonala
//   spotifyUrl?: string; // Opcionális link a zenehallgatáshoz
//   tracks?: string[];   // Dalsorrend / dallista
// };
...
//   albums?: KPopAlbum[]; // <-- Itt vannak az albumok egyenesen a bandán/szólón belül!
//   agency: string;
//   description: string;
...
//         coverImage: "/images/albums/bts-proof.webp",
//         tracks: ["Yet To Come", "Run BTS", "Born Singer"]
//       },
//       {
//         id: "be",
//         title: "BE",
...
//         coverImage: "/images/albums/bts-be.webp",
//         tracks: ["Life Goes On", "Dynamite", "Blue & Grey"]
//       },
//       {
...
//         coverImage: "/images/albums/bts-mots7.webp",
//         tracks: ["ON", "Black Swan", "Filter", "Moon"]
//       }
//     ],
...
//     extendedHistory: `Amikor a BTS (Bangtan Sonyeondan) 2013 nyarán debütált a kis Big Hit Entertainment szárnyai alatt, még senki sem sejtette, hogy hét srác – RM, Jin, Suga, j-hope, Jimin, V és Jung Kook – teljesen átírja a modern zeneipar szabályait. Kezdetben egy olyan ügynökségnél indultak, amelynek alig volt pénze, a nagynevű kiadók pedig esélyt sem adtak nekik a túlélésre. Ők mégis a saját utat választották: dalaikban tabuk nélkül beszélni kezdtek a mindennapi szorongásokról, az iskolai nyomásról, a depresszióról és arról a bizonytalanságról, amivel minden fiatal szembesül a világban.
//                       Ez a hihetetlen őszinteség hozta létre azt a megbonthatatlan köteléket a rajongókkal, az ARMY-val, ami hamarosan globális mozgalommá vált. A valódi áttörést a "The Most Beautiful Moment in Life" éra hozta el számukra, amely nemcsak a zenei stílusukat formálta véglegesen, hanem elindította azt a legendás történetközpontú univerzumot (BU) is, amit a rajongók a a mai napig szenvedéllyel fejtenek meg. Nem telt el sok idő, és a BTS virtuális határokat átlépve a Billboard listák legtetején találta magát, teltházas stadionokat töltött meg Londonunktól Los Angelesig, sőt, történelmi beszédet mondtak az ENSZ közgyűlésén is, hirdetve a "Speak Yourself" – vagyis, hogy találd meg a saját hangod – üzenetet.
//                       Az utóbbi években a koreai törvények szerinti kötelező katonai szolgálat miatt egy időre lelassult a közös munka, hiszen a tagoknak – egymás után váltva – be kellett vonulniuk seregbe. Bár ez nehéz időszak volt a rajongók számára, a fiúk szólóprojektekkel és felejthetetlen pillanatokkal tartották életben a tüzet. Most pedig, ahogy a tagok sorra térnek vissza és újraegyesülnek, egy teljesen új, még érettebb és izgalmasabb korszak veszi kezdetét, bebizonyítva, hogy a BTS nem csupán egy zenei zenekar, hanem egy generáció örök inspirációja.`
//   },
//   {
//     id: "blackpink",
//     name: "Blackpink",
